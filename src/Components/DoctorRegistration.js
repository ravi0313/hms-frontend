        ...
        <div>
          ...
          <div className='row'>
              <div className='col-12'>
                  <h4 className='p-5'><b> Doctor Registration</b></h4>
                ...
                <div className='form-group row m-3'>
                          <label for="experience" class="col-sm-2 col-form-label col-form-label-sm" ><b>Experience</b></label>
                          <div className='col-sm-6'>
                              <input type="number" class="form-control form-control-sm" id="name" placeholder="Experience" required/>
                              <div class="invalid-feedback"> Please enter occupation </div>
                          </div>
                </div>
                ...
                <div className='form-group row m-3'>
                          <label class="col-sm-2 col-form-label col-form-label-sm" ><b>Specialization in Department</b></label>
                          <div className='col-sm-6'>
                              <input type="text" class="form-control form-control-sm" id="name" placeholder="specialization in department" required/>
                              <div class="invalid-feedback"> Please enter occupation </div>
                          </div>
                </div>
